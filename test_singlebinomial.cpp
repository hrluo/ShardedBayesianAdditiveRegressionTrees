//     test.cpp: Binomial tree model class testing/validation code.
...
int main()
{
   ...
   //--------------------------------------------------
   // try instantiating a singlebinomialbrt
   singlebinomialbrt bm;

   double alpha=0.05; //0.01;
   double beta=0.05; //0.01;

   cout  << "##################################################\n";
   cout << "*****Print out first singlebinomialbrt object !!!!\n";
   bm.pr();

   singlebinomialsinfo mi;
   cout << "mi:\n";
   cout << mi.n << ", " << mi.sumy << endl;
   mi.n=10;mi.sumy=3;
   singlebinomialsinfo mi2(mi);
   cout << "mi2:\n";
   cout << mi2.n << ", " << mi2.sumy << endl;

   singlebinomialsinfo mi3(mi2);
   mi3 += mi2;
   cout << "mi3:\n";
