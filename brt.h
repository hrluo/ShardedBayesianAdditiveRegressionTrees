...
public:
   ...
   public:
      tprior(): alpha(.95),beta(1.0),sharding(false),shardepth(0),shardpsplit(0.5),randshard(false) {}
   ...
   void pr();
   void settp(double alpha, double beta, bool sharding, size_t shrdpth, double shardpsplit, bool randshard) {tp.alpha=alpha;tp.beta=beta;tp.sharding=sharding;tp.shardepth=shrdpth;tp.shardpsplit=shardpsplit;tp.randshard=randshard;}
